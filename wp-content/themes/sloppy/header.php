...
<head>
	...
	<link rel="stylesheet" id="wp-block-library-css"
		href="Home 9 – Thype – Personal Blog &amp; Magazine WordPress Theme_files/myscriptfolder/style.min.css"
		type="text/css" media="all">
	<link rel="stylesheet" id="contact-form-7-css"
		href="Home 9 – Thype – Personal Blog &amp; Magazine WordPress Theme_files/myscriptfolder/styles.css"
		type="text/css" media="all">
	...
	<style>
		...
		.posts-form input,textarea,select {
			margin-bottom: 20px;
		}
		a.anchor-submenu{
				position: relative;
